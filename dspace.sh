...
sed -i "s|\(dspace.baseUrl=\).*|\1pc621.sb.statsbiblioteket.dk:1234|g" build.properties
sed -i "s|\(default.language=\).*|\1da_DK|g" build.properties
sed -i "s|\(dspace.name =\).*|\1Statsbiblioteket|g" build.properties
...
sed -i "s|\(dspace.url =\).*|\1pc621.sb.statsbiblioteket.dk:1234/xmlui|g" dspace.cfg
